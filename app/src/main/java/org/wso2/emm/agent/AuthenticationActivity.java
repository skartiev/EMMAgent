...
public class AuthenticationActivity extends SherlockActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(ConfigProperties.AUTO_MODE)
		{
			...
			txtDomain.setEnabled(false); // disable for restrict errors for One tenant version
		}else{
		...
		// XXX: Here is automatization to fill user properties
		if(ConfigProperties.AUTO_MODE){
			username.setText(ConfigProperties.getKey(ConfigProperties.TENANT_VALUE));
			password.setText(ConfigProperties.getProperty(ConfigProperties.TENANT_VALUE));
			//startClientAuthentification();
		}
	}
	...
	protected void onResume() {
		super.onResume();
		// TODO: Here we need to call isRegistered function
	...
	public void showAlert(String message, String title) {
		...
		dialog.setTitle(getResources().getString(R.string.policy_agreement));
	...
	private void startClientAuthentification(){
		...
		if (result != null) {
			...
			if (responseStatus.equals(CommonUtilities.REQUEST_SUCCESSFUL)) {
				...
				if (licenseAgreement != null
					...
					showAlert(licenseAgreement, getResources().getString(R.string.policy_agreement));
				} else {
					showErrorMessage(
							getResources().getString(
